 ...
 */
public class IgnoreElementSplitter extends BaseSplitter {
  private static final IgnoreElementSplitter INSTANCE = new IgnoreElementSplitter();

  public static IgnoreElementSplitter getInstance() {
    return INSTANCE;
  }
